      ...
      <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <button
              type="submit"
              className="w-full px-4 py-2 font-medium text-white bg-[#FB7185] rounded-lg hover:bg-[#F43F5E] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#F43F5E]"
            >
              Proceed
            </button>
            {errorMessage && (
        ...
        <p className="text-sm text-center text-gray-600">
          ...
          <Link to="/signin" className="text-[#FB7185] hover:underline">
            Login
          </Link>
        </p>
      </div>
